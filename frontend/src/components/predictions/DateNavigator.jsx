  ...
  return (
    <div className="relative max-w-xl mx-auto flex items-center justify-center my-3 px-8 sm:px-12">
      ...
      <button
        ...
        className="absolute left-5 sm:left-10 w-8 h-8 sm:w-10 sm:h-10 rounded-full
      ...
      <span className="text-medium sm:text-medium font-semibold text-gray-800 text-center select-none">
        {formattedDate}
      </span>
      ...
      <button
        ...
        onMouseDown={(e) => e.preventDefault()}
        className={`absolute right-5 sm:right-10 w-8 h-8 sm:w-10 sm:h-10 rounded-full
