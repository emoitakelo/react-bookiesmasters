  ...
  return (
    <footer className="bg-gray-900 font-semibold text-gray-400 px-3 mt-5">
      ...
      <div className="max-w-3xl mx-auto px-2 md:px-4 py-1 grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-gray-700">
        ...
        {/* Brand / About */}
        <div>
          <h5 className="text-sm text-white mb-1">Bookiesmasters</h5>
        ...
        {/* Contact / Socials */}
        <div>
          <h5 className="text-sm text-white mb-1">Stay connected</h5>
        ...
        {/* Quick Links */}
        <div>
          <h5 className="text-sm text-white mb-1">Quick links</h5>
